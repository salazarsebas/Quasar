...
use quasar_syntax::ast::{Program, Value};
use quasar_syntax::span::Span;

// ---------------------------------------------------------------------------
// Minimal ABI types (duplicated from quasar-exec to avoid heavy deps)
// ---------------------------------------------------------------------------
...
mod tests {
    use super::*;
    use quasar_syntax::ast::{Call, Directive, Program, UseDecl};
    use quasar_syntax::span::Span;
